...
import '../../features/levels/presentation/level_selection_placeholder_screen.dart';
...
class AppRoutes {
  ...
  static Route<void> onGenerateRoute(RouteSettings routeSettings) {
    final builder = switch (routeSettings.name) {
      ...
      levels => (_) => const LevelSelectionPlaceholderScreen(),
      game => (_) => const GamePlaceholderScreen(),
