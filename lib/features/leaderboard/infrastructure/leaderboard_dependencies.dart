...
import '../application/get_leaderboard_use_case.dart';
...
class LeaderboardDependencies {
  ...
  static Future<GetLeaderboardUseCase> createGetLeaderboardUseCase() async {
    return GetLeaderboardUseCase(
      ApiLeaderboardRepository(await NetworkDependencies.createApiClient()),
    );
  }
